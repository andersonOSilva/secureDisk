...
class PlanPolicyDetailResource(Resource):

    def _get_plan_policy(self, id_plan):
    ...
    def put(self, id):
        ...
        try:
            ...
            if item:
                model = PlanPolicyModel.get_by_id(id)
    ...
    def delete(self,id):
        try:
            plan = PlanPolicyModel.get_by_id(id)
            plan.delete()
